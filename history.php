...
$exportQuery="SELECT * FROM Watch_Movies WHERE email_id = '".$email."' ";
...
$export_output = json_encode($export_data);
$file_name = 'output.json';
if(file_put_contents($file_name, $export_output)){
	echo '<div id="download">                                                                                                                                           
             <center>
             <br>
             <p> Click the link below to download your history in json format!</p>
			 <a href="output.json" download>
             Download Here!
             </a>
             </center>                                                                                                                                                        
             </div>';
